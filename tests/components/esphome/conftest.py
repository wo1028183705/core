...
class MockESPHomeDevice:
    ...
    def __init__(
        ...
        self.voice_assistant_handle_announce_finished_callback: (
            Callable[
                [VoiceAssistantAnnounceFinished],
                Coroutine[Any, Any, None],
            ]
    ...
    async def mock_voice_assistant_handle_announce_finished(
        self, announce_finished: VoiceAssistantAnnounceFinished
    ) -> None:
        """Mock voice assistant handle announce finished."""
        assert self.voice_assistant_handle_announce_finished_callback is not None
        await self.voice_assistant_handle_announce_finished_callback(announce_finished)
    ...
    def _subscribe_voice_assistant(
        *,
        ...
        mock_device.set_subscribe_voice_assistant_callbacks(
            handle_start, handle_stop, handle_audio, handle_announce_finished
        )
